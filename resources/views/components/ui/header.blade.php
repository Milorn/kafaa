<header class="bg-white py-6 px-5 border-b-2 border-b-primary sticky top-0 z-50">
    <nav class="flex justify-between items-center mx-auto max-w-screen-xl">
        ...
        <ul>
            ...
            <li class="inline-block mx-2 pb-3 @if(request()->routeIs('blog')) link-active @else font-medium text-trivial @endif"><a href="/blog">Blog</a></li>
            <li class="inline-block ml-12">
                <div class="flex flex-col gap-2">
                    <a href="/register" class="btn-primary btn-icon">S'enregistrer <x-heroicon-o-arrow-right class="size-5 text-white stroke-2"/> </a>
